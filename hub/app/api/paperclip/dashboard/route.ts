...
const log = createLogger('paperclip/dashboard')
...
export async function GET(req: Request) {
  ...
  try {
    ...
    const message = error instanceof Error ? error.message : 'Failed to load execution dashboard'
    log.error({ err: error }, 'Execution dashboard fetch failed')
