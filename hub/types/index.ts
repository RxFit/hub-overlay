...
export interface ToolPanelContentProps {
  ...
  /** The live conversation id — deep-run panels attach runs to it so a
   *  finished report can point back into the originating chat. Optional:
   *  the classic parse-the-transcript panels never need it. */
  chatId?: string | null
}
