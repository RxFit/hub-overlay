...
### Wednesday — GEO (Generative Engine Optimization)
...
- Identify highest-traffic pages with lowest conversion rates
- A/B test hypothesis: queue 1 copy or layout variation for human approval
- Check: booking flow friction points — where are users dropping off?
...
- Pull performance metrics: impressions, clicks, CTR, CPC, conversions
- Flag any ad sets with CPA > threshold (confirm threshold with founder)
- Surface top-performing creative for scaling recommendation
- Flag underperforming campaigns for pause — queue for human approval
- Review competitor paid activity (SpyFu / SEM signals)
